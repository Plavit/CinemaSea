    ...
    */
    ...
    public void run(){
        ...
        try {
            ...
            String sql = "CREATE OR REPLACE VIEW movietags AS\n" +
                        "SELECT movie.id_movie, tags.type\n" +
                        "FROM movie, tags, tag_related\n" +
                        "WHERE movie.id_movie = tag_related.id_movie AND tag_related.id_tag = tags.id_tag;";
            stmt.executeUpdate(sql);
            
            System.out.println("VIEW(tags) CREATED");
