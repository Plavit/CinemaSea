...
/**
 * Thread that creates VIEW in database called usermovies
 *
 * @author Löffler David, Szeles Marek
 */
public class viewUserMovies extends Thread{
    ...
    */
    ...
    public void run(){
        ...
        try {
            ...
            String sql = "CREATE VIEW usermovies AS SELECT users.id_user, movie.id_movie\n"
            ...
            System.out.println("VIEW(users movies) CREATED");
